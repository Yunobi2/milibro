    ...
    <div class="d-flex">
        <aside class="bg-dark text-white p-3" style="width: 250px;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ request()->routeIs('dashboard.books') ? 'active' : '' }}" href="{{ route('dashboard.books') }}">
                        <img title="Gestión de Libros" src="{{asset('icons/libros.svg')}}" alt="icono gestion de libros"> GESTIÓN DE LIBROS
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white {{ request()->routeIs('dashboard.reports') ? 'active' : '' }}" href="{{ route('dashboard.reports') }}">
